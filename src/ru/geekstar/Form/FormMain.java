...
public class FormMain extends JDialog {
    ...
    public FormMain() {
        ...
        PhysicalPerson I = new PhysicalPerson("Илья", "Перепелкин", "+79277394841", LocalDate.of(1992, 7, 15), 'M');
    ...
    public void updateDisplaySwitchAccountForMulticurrencyCard() {
        ...
        // запрашиваем дополнительные мультивалютные счета карты
        ArrayList<PayCardAccount> multicurrencyAccounts = multicurrencyCard.getMulticurrencyAccounts();
        // добавляем в список дополнительные мультивалютные счета карты для переключения между счетами
        ...
        // если список с кодами валют уже содержит коды валют мультивалютных счётов карты, то удаляем коды валют уже существующих счётов карты из списка
