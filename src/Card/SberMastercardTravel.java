...
public class SberMastercardTravel extends CardMastercard implements IMulticurrencyCard {
    ...
    public void addAccount(String currencyCodeAccount) {
        ...
        SberPayCardAccount sberPayCardAccount = (SberPayCardAccount) (((Sberbank) this.getBank()).openAccount(account.getAccountHolder(), new SberPayCardAccount(), currencyCodeAccount));
